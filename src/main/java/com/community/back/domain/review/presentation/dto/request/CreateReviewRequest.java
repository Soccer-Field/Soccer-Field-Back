...
public class CreateReviewRequest {
    ...
    @Schema(description = "잔디 타입", example = "AG", allowableValues = {"AG", "FG", "MG", "TF"})
    private String grassType;

    @Schema(description = "잔디 상태 특징 (복수 선택 가능)", example = "[\"딱딱함\", \"잔디 짧음\"]")
    private List<String> grassConditions;

    @NotBlank(message = "추천 축구화는 필수입니다")
    @Schema(description = "추천 축구화 타입", example = "AG", allowableValues = {"AG", "FG", "MG", "TF"})
    private String recommendedShoe;

    @Schema(description = "추천 축구화 링크 (선택)", example = "https://www.nike.com/shoes")
